...
<section>
  <div class="relative px-6 pt-10 pb-8 sm:max-w-6xl sm:mx-auto sm:rounded-lg sm:px-5 text-center">
    ...
    <div class="flex flex-wrap justify-center relative mt-10">
      <a class="m-2" href={bundle.links.docs}><i class="fas fa-book"></i> Dokumentace</a>
      <a class="m-2" href={bundle.links.twitter}><i class="fab fa-twitter"></i> Twitter</a>
      <a class="m-2" href={bundle.links.discord}><i class="fab fa-discord"></i> Discord</a>
      <a class="m-2" href={bundle.links.telegram}><i class="fab fa-telegram-plane"></i> Telegram</a>
      <a class="m-2" href={bundle.links.fbevent}><i class="fab fa-facebook"></i> Facebook</a>
    </div>
